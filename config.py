...
EXCLUDED_DAILY_USERS = [347768204602507266, 1365421859142631514, 1164970747077337088, 1516167293409689640, 155149108183695360, 159985870458322944, 431544605209788416, 302050872383242240]  # user IDs that should never get daily reward pings (e.g. bots, alt accounts, staff test accounts)
